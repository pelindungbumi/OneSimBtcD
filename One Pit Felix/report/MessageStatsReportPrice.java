 ...
 */
public class MessageStatsReportPrice extends Report implements MessageListener {
    ...
    private ArrayList<Message> price;
     ...
     * Constructor.
     */
    public MessageStatsReportPrice() {
        init();
    }
    ...
    protected void init() {
        ...
        this.price = new ArrayList<Message>();
    ...
    public void done() {
        ...
        for (int i = 0; i < price.size(); i++) {
            cetak+= price.get(i)+" : ";
            cetak+=price.get(i).getProperty("rewards").toString()+"\n";
        }
